          ...
          <div style={{width:"100vw", height:"50vh"}} >
            <div className="d-flex w-50 h-100 workContainer" style={{position:'relative', marginLeft:'15%'}}>
              ...
              <div style={{width:'100%', backgroundColor: '#E5E5E5', opacity:'0.95',position:'absolute', top:'200px', left:'250px', boxShadow: '2px 2px 5px grey', textAlign:'justify'}} className="workDescriptionContainer my-auto mx-auto text-start p-3 w-80">
                ...
                <p className="workDescription" style={{fontSize:"100%"}}> They say the floor is the sole of the house, no home is complete without an amazing looking floor. Have your current tiles hacked and overlayed, or replace them with marble or parquet flooring. Elevate your home experience with our great flooring options.</p>
              </div>
